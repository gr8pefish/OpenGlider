...
public class ConfigHandler {
    ...
    public static void syncConfig() {
        ...
        forwardMovementShift = config.getFloat("3) Fast Forward Movement", category, 0.08F, 0, 100,"The amount of blocks to move forwards (per-tick) while gliding fast (pressing 'Shift')."); //ToDo: lessen as per insomnia's suggestion, she halved it
